...
public class FrmPacientes extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        ComboTipoDocumentoRegis.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        comboEntidadRegis.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
    ...
    //CREAMOS ESTE METODO PUBLICO PARA PODER LLAMAR LOS DATO A MODIFICAR EN LA CLASE BUSQUEDA, ASI MISMO PODREMOS MOSTRAR LA VISTA DE ESTA CLASE AL MOMENTO DE DARLE MODIFICAR
    ...
    // 1. Cambiamos la acción a editar y guardamos el ID y documento antiguo
    this.accion = "editar";
    this.idPaciente = id;
    this.documentoAnt = documento;

    // 2. Llenamos los componentes visuales de la pestaña de registro
